...
class PatientsListView extends StatefulWidget {
  const PatientsListView({Key key, this.callBack}) : super(key: key);

  final Function callBack;
  @override
  _PatientsListViewState createState() => _PatientsListViewState();
}
          ...
          if (!snapshot.hasData) {
            ...
            return GridView(
              ...
              children: List<Widget>.generate(
                Patient.popularCourseList.length,
                (int index) {
                  final int count = Patient.popularCourseList.length;
                  ...
                  return CategoryView(
                    ...
                    category: Patient.popularCourseList[index],
                    animation: animation,
                    animationController: animationController,
                  );
                },
...
//                                               children: <Widget>[
//                                                 Text(
//                                                   '${category.lessonCount} Exercises',
//                                                   textAlign: TextAlign.left,
//                                                   style: TextStyle(
//                                                     fontWeight: FontWeight.w200,
//                                                     fontSize: 9,
